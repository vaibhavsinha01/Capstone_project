...
exchange="NSE"
option_exchange = "NFO"
token_id = "3045" # token_id = "11536" # token_id = "99926000" # token_id="12815"# token_id="9931"
tradingsymbol = "SBIN-EQ" # changed from SBIN-EQ # tradingsymbol = "SBIN-EQ" # tradingsymbol = "TCS-EQ" # tradingsymbol = "NIFTY50" #tradingsymbol="TATAINVEST-BL" # tradingsymbol="VIKASLIFE-EQ"
timeframe="ONE_MINUTE" # "ONE_MINUTE","THREE_MINUTE","FIVE_MINUTE","TEN_MINUTE","FIFTEEN_MINUTE","THIRTY_MINUTE","ONE_HOUR","ONE_DAY"
profit_percentage = 0.003 # 0.5 percentage tp
max_mul = 2
x_factor = 2 # make this more than one ruppee # suppose it is 50 points take min of price-50 / price*(1-0.01)
y_factor = 3 # this is the maximum loss due to fake entries
use_data_for_x_days=100
min_max_choice = 0
heiken_ashi_choice = 0
initial_quantity = 1 
